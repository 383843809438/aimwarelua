...
--NM(gui.Reference("Legitbot"),"合法机器人")
--gui.Reference("Legitbot"):SetName("合法机器人")
NM(RF("合法机器人","Master Switch"),"总开关")


NM(RF("合法机器人","Aimbot"),"合法自瞄")
NM(RF("合法机器人","合法自瞄","Toggle"),"触发方式")
...
NM(RF("暴力机器人","武器杂项","Rapid Fire"),"快速射击")
for i = 1, 11, 1 do
   NM(RF("暴力机器人","武器杂项","快速射击",WEN[i],"Enable"),"启用")
   NM(RF("暴力机器人","武器杂项","快速射击",WEN[i],"Show indicator"),"显示速射充能") 
end

NM(RF("暴力机器人","武器杂项","Movement"),"运动")
NM(RF("暴力机器人","武器杂项","运动","Slow Walk Key"),"慢走按键")
NM(RF("暴力机器人","武器杂项","运动","Slow Walk Speed"),"慢走速度")
NM(RF("暴力机器人","武器杂项","运动","Quick Stop"),"快速急停")

NM(RF("暴力机器人","武器杂项","Walkbot"),"Peek")
...
NM(RF("视觉效果","世界","帮助","投掷物指示器","Color Fade"),"颜色渐变")
...
NM(RF("视觉效果","世界","帮助","Bullet Tracers Mode"),"子弹轨迹模式")
RF("视觉效果","世界","帮助","子弹轨迹模式"): SetOptions("关闭","最新","全部")
NM(RF("视觉效果","世界","帮助","Bullet Tracers Filter"),"子弹轨迹过滤器")
NM(RF("视觉效果","世界","帮助","子弹轨迹过滤器","Local"),"自己")
NM(RF("视觉效果","世界","帮助","子弹轨迹过滤器","Friendly"),"队友")
NM(RF("视觉效果","世界","帮助","子弹轨迹过滤器","Enemy"),"敌人")
...
NM(RF("视觉效果","其它功能","额外","Preserve Killfeed"),"保留击杀信息")
...
NM(RF("视觉效果","其它功能","特效","特效移除","No Scope"),"移除开镜动画")
NM(RF("视觉效果","其它功能","特效","特效移除","No Scope Overlay"),"无瞄准镜叠加")
NM(RF("视觉效果","其它功能","特效","特效移除","No Sky"),"移除天空")
NM(RF("视觉效果","其它功能","特效","Night Mode"),"夜间模式")
NM(RF("视觉效果","其它功能","特效","Night Mode Intensity"),"夜间模式强度")
...
NM(RF("杂项功能","一般功能","主要的","Show Spectators"),"显示观战玩家")
...
NM(RF("杂项功能","增强功能","Appearance"),"外貌")--Appearance

NM(RF("杂项功能","增强功能","外貌","Chat Spam"),"发送AW广告")
